  ...
  return (
    <section className="bg-white py-32">
      <div className="app-container mx-auto px-4">
        ...
        <div className="text-[14px] leading-[1.75] text-gray-600 space-y-5 font-thin">
          <h2 className="font-semibold text-gray-900 text-2xl">
            Welcome to Nutriient!
          </h2>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Digital Hub's Website, located at www.nutriient.in.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Nutriient if you do not agree to
          ...
          <div className="pt-5 space-y-5">
            <h2 className="font-semibold text-gray-900 text-2xl">Cookies</h2>
            <p>
              We employ the use of cookies. By accessing Nutriient, you agreed
              to use cookies in agreement with the Digital Hub's Privacy Policy.
            </p>
            <p>
          ...
          <div className="space-y-5">
            <h2 className="font-semibold text-gray-900 text-2xl">License</h2>
            <p>
              Unless otherwise stated, Digital Hub and/or its licensors own the
              intellectual property rights for all material on Nutriient. All
              intellectual property rights are reserved. You may access this
              from Nutriient for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>

            <div>
              <p className="mt-2 font-semibold">You must not:</p>
              <ul className="space-y-1">
                {[
                  "Republish material from Nutriient",
                  "Sell, rent or sub-license material from Nutriient",
                  "Reproduce, duplicate or copy material from Nutriient",
                  "Redistribute content from Nutriient",
                ].map((item, i) => (
          ...
          <p>
            ...
            Digital Hub does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Digital Hub, its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Digital
            Hub shall not be liable for the Comments or for any liability,
            ...
            Digital Hub reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Digital Hub a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Digital Hub;
          ...
          <p>
            ...
            sending an e-mail to Digital Hub. Please include your name, your
          ...
          <div>
            ...
            <p className="pt-3">
              No use of Digital Hub's logo or other artwork will be allowed for
          ...
          <div className="mb-10 space-y-5">
            <h2 className="font-semibold text-gray-900 text-2xl">iFrames</h2>
            <p>
          ...
          {/* Disclaimer */}
          <div>
            <h2 className="font-semibold text-gray-900 text-2xl">Disclaimer</h2>
            <p className="mt-2 font-semibold">
